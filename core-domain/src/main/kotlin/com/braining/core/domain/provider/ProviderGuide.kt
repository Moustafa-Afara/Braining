...
object ProviderGuide {
    ...
    fun of(id: ProviderId): Guide = when (id) {
        ...
        // The one entry that is not a website. Its "key page" is Ollama's download, and its
        // "terms" are the setup steps — because what this provider needs first is not an account,
        // it is a program running on a computer the user owns.
        ProviderId.OLLAMA -> Guide(
            keyUrl = "https://ollama.com/download",
            docsUrl = "https://docs.ollama.com/faq",
            keyPrefix = "",
            freeTier = true,
            regionLimited = false,
        )
